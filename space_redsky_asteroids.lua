...
minetest.register_on_generated(otherworlds.asteroids.create_on_generated(YMIN, YMAX, {
    ...
    c_ironore = minetest.get_content_id("asteroid:red_ironore"),
    c_copperore = minetest.get_content_id("asteroid:red_copperore"),
    c_coalore = minetest.get_content_id("asteroid:red_coalore"),
    c_diamondore = minetest.get_content_id("asteroid:red_diamondore"),
    c_meseore = minetest.get_content_id("asteroid:red_meseore"),
